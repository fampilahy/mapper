...
public class ProductCoverage extends ChubbDocument {
	...
	public ProductCoverage(Integer benefitLevelID, String coverageCode, String coverageDescription, String individual,
			Double MI_CVG_AMT, Double MI_TAX_BEN_AMT, Double SPS_CVG_AMT, Double SP_TAX_BEN_AMT, Double DEP_CVG_AMT,
			Double DP_TAX_BEN_AMT, Double MALE_PCT, Double FEMALE_PCT, Double UNISEX_PCT, Double RF_REFERENCE, String DESCRIPTION, String BRIEF_TEXT) {
		...
		this.RF_REFERENCE = RF_REFERENCE;
	...
	public void setRF_REFERENCE(Double rF_REFERENCE) {
	...
	public void setBRIEF_TEXT(String bRIEF_TEXT) {
